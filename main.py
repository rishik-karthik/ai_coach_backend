...
from services.ui.styles import load_css, inject_local_font, inject_webrtc_styles
from services.persistence.exercise_repo import init_db
from streamlit_webrtc import webrtc_streamer, WebRtcMode
from services.vision.exercise_video_pro import VideoProcessorClass
...
def main():
    ...
    init_db()
    #if loged in returs true, next part of code runs
    #else return  
